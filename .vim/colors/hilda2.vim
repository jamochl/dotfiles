...
call Color("Comment", "NONE", "#949494", "NONE", "NONE", "246")
call Color("Normal", "NONE", s:gui07, "NONE", "NONE", "7")
call Color("Constant", "NONE", s:gui12, "NONE", "NONE", "12")
...
" call Color("Identifier", "NONE", s:gui01, "NONE", "NONE", "1")
" call Color("Function", "NONE", s:gui06, "bold", "NONE", "6")
" call Color("Identifier", "NONE", s:gui12, "NONE", "NONE", "12")
" call Color("Function", "NONE", s:gui12, "bold", "NONE", "12")
call Color("Identifier", "NONE", s:gui04, "NONE", "NONE", "4")
call Color("Function", "NONE", s:gui04, "bold", "NONE", "4")
" call Color("Statement", "NONE", s:gui12, "italic", "NONE", "12")
call Color("Statement", "NONE", s:gui05, "italic", "NONE", "5")
" call Color("Keyword", "NONE", s:gui12, "italic", "NONE", "12")
" call Color("Identifier", "NONE", s:gui12, "NONE", "NONE", "12")
" call Color("Function", "NONE", s:gui12, "bold", "NONE", "12")
" call Color("Statement", "NONE", s:gui06, "italic", "NONE", "6")
call Color("PreProc", "NONE", s:gui02, "bold", "NONE", "2")
call Color("Type", "NONE", s:gui02, "NONE", "NONE", "2")
call Color("StorageClass", "NONE", s:gui02, "italic", "NONE", "2")
hi! link Typedef StorageClass
call Color("Special", "NONE", s:gui03, "NONE", "NONE", "3")
